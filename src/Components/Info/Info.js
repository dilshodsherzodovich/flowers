                ...
                <div className="container info__container">
                    <time className="info__time">Пн-Сб: 8:00–20:00 Вс: 9:00–20:00</time>
                        <ul className="info__list">
                            ...
                            <li>
                                <button onClick={handleBtnOpened} className="info__btn info__btn--active">Информация</button>
                                <ul className={opened ? "dropdown dropdown--opened" : "dropdown"}>
                                    ...
                                    <li className="dropdown-list__item">
                                        <Link className="dropdown-list__link">Корпоративным клиентам</Link>
                                    </li>
                                    <li className="dropdown-list__item">
                    ...
                    <ul className="info__list">
                        <li className="info__item">
                            ...
                            <a href="https://vk.com" target="_blank" className="info__item-link">
                                <img src={contact} alt="v contacte icon" width={24} height={24} />
                            </a>
                        </li>
                        <li className="info__item">
                            {/* eslint-disable-next-line */}
                            <a href="https://instagram.com" target="_blank" className="info__item-link">
                                <img src={instagram} alt="instagram icon" width={18} height={18} />
                            </a>
                        </li>
